...
InfoDay4 = "Gut gemacht! </br> Kara geht immer ein Feld nach vorne, wenn ein Mushromm (Pilz vor ihm ist oder wenn dort keiner ist, also immer. Bei jedem schritt überprüft er ob ein Blat unter ihm ist, wenn dies der fall ist nimmt er es auf. Wenn Kara auf dem Feld vor dem ersten Pilz ist, dreht er sich nach Links, wenn er auf dem Feld vor dem zweiten Pilz ist, geht sie ein Feld nach vorne uns schibt den Pilz mit nach Vorne, da Kara aber nur ein Pilz zur Zeit schieben kann, kommt es beim nächsten versuch nach vorne zu gehen zu einem Error (Fehler), da Kara versucht zwei Pilze zu schiben.";
InfoDay5 = "1";
InfoDay6 = "1";
InfoDay7 = "1";
InfoDay8 = "1";
